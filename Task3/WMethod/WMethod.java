...
public class WMethod{
   ...
   */
   public static void main(String [] args){
     ...
     //Print out results of test inputs
     int i = 0;
     for(String testCase : tests)
     {
    	 ...
    	 System.out.println("String pattern = \"" + testCase + "\" ;");
    	 if(Utilities.runFSM(FSM, 1, testCase.replace("", " ").trim()," "))
    		System.out.println("assertTrue(JamesBond.BondMatch(pattern)); }");	 
    	 else
    		System.out.println("assertFalse(JamesBond.BondMatch(pattern)); }");	
